...
"[1]format=rgba,fade=d=1:t=in:alpha=1,setpts=PTS-STARTPTS+4/TB[f0]; \
 ...
 [5]format=rgba,fade=d=1:t=in:alpha=1,setpts=PTS-STARTPTS+20/TB[f4]; \
 [6]format=rgba,fade=d=1:t=in:alpha=1,setpts=PTS-STARTPTS+24/TB[f5]; \
 [7]format=rgba,fade=d=1:t=in:alpha=1,setpts=PTS-STARTPTS+28/TB[f6]; \
